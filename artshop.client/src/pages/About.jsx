...
export default function About() {
    return (
        <div className="about-container">
            ...
            <h2>Q: I need help with a specific issue with my order or question!</h2>
            <p>Let me know at telremart@gmail.com and I will do my best to help!</p>
            <h2>Q: What tools/programs do you use?</h2>
            <p>My drawing program of choice is Krita <br />
                I use an xp-pen artist 22R pro drawing tablet <br />
                For compiling reference material I use pureref</p>
            <h2>Q: Who are your inspirations?</h2>
            <p>Many artists such as Reiq, TWAQ, Merunyaa, Slugbox, Buru, among others! I am also inspired by the art of anime studios like Studio Trigger and of fighting games such as Street Fighter, Guilty Gear, etc.</p>
            <h2>Q: Can I repost your work?</h2>
